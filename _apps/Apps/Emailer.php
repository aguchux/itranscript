...
class Emailer
{
	...
	public $fromEmail = "itranscript@esut.edu.ng";
	public $fromName = "iTranscript@ESUT";
	public $replyEmail = "itranscript@esut.edu.ng";
	public $replyName = "iTranscript.@ESUT";
	public $subject = "iTranscript@ESUT";
