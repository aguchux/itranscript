    ...
    <div class="row">
        <div class="col-lg-7">
            ...
            <div class="page-section">
                ...
                <form action="/forms/my/user/<?= $AccidInfo->accid ?>/setaccid" method="POST" class="p-0 mx-auto">
                        ...
                        <div class="list-group-item">
                            ...
                            <div class="row">
                                ...
                                <?php if ($UserInfo->is_owner) : ?>
                                    ...
                                    <div class="col-lg-12">
                                        <h4 class="card-title">Make Tracker/Updater</h4>
                                        <p class="text-70">make this user a data updater.</p>
                                    </div>
                                    <div class="col-lg-12 d-flex align-items-center">
                                        <div class="flex">
                                            <label class="form-label" for="is_bursary">Tracker & Updater</label><br>
                                            <div class="custom-control custom-radio-toggle custom-control-inline mr-1">
                                                <input type="radio" <?= $AccidInfo->is_admin == 4 ? 'checked' : '' ?> id="is_tacker" name="is_admin" value="4" class="custom-control-input">
                                                <label class="custom-control-label" for="is_tacker"><?= $AccidInfo->is_admin == 4 ? 'Yes' : 'No' ?></label>
                                            </div>
                                        </div>
                                    </div>
