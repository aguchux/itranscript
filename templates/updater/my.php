<div class="container page__container">
    <form action="/forms/my/updater/searchpayment" method="POST" class="p-0 mx-auto">
        <?= $Self->tokenize() ?>
        <div class="row">
            ...
            <div class="col-lg-7">
                ...
                <div class="page-section">
                    <h4>Search Accounts & Payments</h4>
                    <?= $Self->Toast() ?>
                    <div class="list-group-item">
                        <div class="form-group row mb-0">
                            <label class="col-form-label col-sm-4">Email, Invoice OR Application Number</label>
                            <div class="col-sm-8">
                                <input type="text" name="query" required class="form-control" placeholder="Search ...">
                                <div class="page-nav__content mt-2">
                                    <button type="submit" class="btn btn-accent">Quick Search</button>
                                </div>
                            </div>
                        </div>
                    </div>
