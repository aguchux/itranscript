            ...
            <div class="col-lg-12">
                <div class="page-section">
                    ...
                    <table id="MyDatatable" class="display" style="width:100%">
                        ...
                        <tbody>
                            <?php while ($verification = mysqli_fetch_object($Verifications)) : $User = $Core->UserInfo($verification->accid); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="/my/admin/verifications/<?= $verification->id ?>/view" class="btn-link">View</a> | <a href="/admin/transcripts/<?= $verification->id ?>/reciept">Invoice</a>
                                    </td>
