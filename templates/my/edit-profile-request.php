<div class="container page__container">
    <form action="./forms/my/edit-profile-request" method="POST" class="p-0 mx-auto">
        <?= $Self->tokenize() ?>
        <div class="row">
            <div class="col-lg-7">

                <div class="page-section">
                    <h4>Request Profile Update &amp; Basic Details (Admin only)</h4>
                    <div class="list-group list-group-form">


                        <div class="list-group-item">
                            <div class="form-group row mb-0">
                                <p class="text-success my-1">Profile update request will be forwarded to the administrator for approval. Profile changes will take effect after admin approval.</p>
                        ...
                        <div class="list-group-item">
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="middlename" required class="form-control" value="<?= $UserInfo->middlename ?>" placeholder="Middlename ...">
                                </div>
                            </div>
                        </div>
