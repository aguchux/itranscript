<div class="container page__container">
    <form action="./forms/my/transcript/transcript-verification" method="POST" class="p-0 mx-auto">
        <?= $Self->tokenize() ?>
        <div class="row">
            <div class="col-lg-7">
                ...
                <div class="page-section">
                    ...
                    <div class="list-group list-group-form">
                        ...
                        <div class="list-group-item">
                            ...
                            <div class="row">
                                <div class="col-lg-7">
                                    <h4 class="card-title">International OR Local?</h4>
                                    <p class="text-70">Select/Check this if transcript verification is requested for international use or requires sending abroad.</p>
                                </div>
