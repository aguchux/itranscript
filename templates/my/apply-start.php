<div class="container page__container">
    <form action="./forms/my/transcript/<?= $Transcript->id ?>/apply-start" method="POST" class="p-0 mx-auto" enctype="multipart/form-data">
        <?= $Self->tokenize() ?>
        <div class="row">
            <div class="col-lg-7">
                    ...
                    <div class="card card-body mb-32pt">
                        <div class="row">
                            <div class="col-lg-7">
                                ...
                                <p class="text-70">Select/Check this if transcript is requested for international use.</p>
                            </div>
                            <div class="col-lg-5 d-flex align-items-center">
                                <div class="flex">
                                    ...
                                    <div class="custom-control custom-checkbox-toggle custom-control-inline mr-1 disabled">
                                        <input type="checkbox" disabled required id="international" name="international" <?= $Transcript->international == 1 ? 'checked' : '' ?> value="1" class="custom-control-input">
                                        <label class="custom-control-label disabled" for="international"><?= $Transcript->international == 1 ? 'Yes' : 'No' ?></label>
                                    </div>
                                    <label class="form-label mb-0 text-success" for="international"><?= $Transcript->international == 1 ? 'Yes, International' : 'No, local' ?></label>
                                </div>
                            </div>
                    ...
                    <div class="list-group list-group-form">
                        ...
                        <div class="list-group-item">
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" required aria-required="true" name="matricnumber" class="form-control" disabled placeholder="MATRIC NUMBER" value="<?= $Transcript->matricnumber ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="list-group-item">
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-9">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <select class="form-control" name="dob_day" required aria-required="true">
                                                <option value="">Day</option>
                                                <?= $Core->LoadDobDay($UserInfo->dob_day) ?>
                                            </select>
                                        </div>
                                        <div class="col-sm-4">
                                            <select class="form-control" name="dob_month" required aria-required="true">
                                                <option value="">Month</option>
                                                <?= $Core->LoadDobMonth($UserInfo->dob_month) ?>
                                            </select>
                                        </div>
                                        <div class="col-sm-4">
                                            <select class="form-control" name="dob_year" required aria-required="true">
