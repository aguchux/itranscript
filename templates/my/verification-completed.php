<div class="bg-primary py-32pt">
    <div class="container d-flex flex-column flex-sm-row align-items-sm-center">
        <div class="flex">
            <h1 class="text-white flex mb-0 text-success">Verification was successful</h1>
            <p class="lead text-white-50">You don't need to do anything, just sit back and wait while we process your verification</p>
        </div>
        <p class="d-sm-none"></p>
        <a href="./my/apps/verifications/<?= $Transcript->id ?>/status" class="text-success btn btn-outline-white flex-column">
           Check Status
