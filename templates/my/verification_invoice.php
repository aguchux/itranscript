        ...
        <div class="row">
            <div class="col-lg-9">
                ...
                <div class="page-section">
                    <h4>Verification Payment Information (#<?= $TranscriptInfo->id ?>)</h4>
                    ...
                    <div class="card table-responsive">
                        <table class="table table-flush table--elevated">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <p class="mb-0"><strong>Verification Processing Fee - (<?= $TranscriptInfo->international ? "International" : "National/Local" ?>)</strong></p>
                                        <p class="text-50 mt-3 mb-1 ml-2">Application Number: <strong>#<?= $TranscriptInfo->id ?></strong></p>
                                        <p class="text-50 mt-3 mb-1 ml-2">Verification Type: <strong class="text-primary"><?= ucfirst($TranscriptInfo->verify) ?> Verification</strong></p>
