<div class="container page__container">
    ...
    <?php if ($Core->ProfileScore($UserInfo->accid) < 110) : ?>
        ...
        <div class="card border-left-4 mt-5 mb-3 border-left-accent card-sm">
    ...
    <?php else : ?>
        ...
        <?php if ($Core->HasApplication($UserInfo->accid) || $Core->HasVerification($UserInfo->accid)) : ?>
        ...
        <?php else : ?>
            <div class="card border-left-4 my-5 border-left-accent card-sm">
                <div class="card-body pl-16pt">
                    <div class="media flex-wrap align-items-center">
                        <div class="media-left">
                            <i class="material-icons text-50">access_time</i>
                        ...
                        <div class="media-body" style="min-width: 180px">
                            Start a new transcript application</strong>
                        </div>
                        <div class="media-right mt-2 mt-sm-0">
        ...
        <div class="d-none card border-left-4 mt-5 mb-5 border-left-accent card-sm">
            <div class="card-body pl-16pt">
                <div class="media flex-wrap align-items-center">
                    <div class="media-left">
                        <i class="material-icons text-50">access_time</i>
        ...
        <div class="row mt-5">
            <div class="col-4 col-md-4 col-sm-12 ESUTProduct">
                <a href="/my/apps/apply"><img src="<?= $assets ?>images/transcript.png" class="img-fluid"></a>
            </div>
            <div class="col-4 col-md-4 col-sm-12 ESUTProduct">
                <a href="/my/apps/verifications"><img src="<?= $assets ?>images/verification.png" class="img-fluid"></a>
            </div>
            <div class="col-4 col-md-4 col-sm-12 ESUTProduct">
                <a href="/my/"><img src="<?= $assets ?>images/covernote.png" class="img-fluid"></a>
            </div>
        </div>
