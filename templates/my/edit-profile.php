                    ...
                    <div class="list-group list-group-form">
                        ...
                        <div class="list-group-item">
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="surname" required <?= strlen($UserInfo->surname) >= 3 ? 'readonly aria-readonly="true"' : '' ?> class="form-control" value="<?= $UserInfo->surname ?>" placeholder="Surname ...">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="list-group-item">
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="firstname" <?= strlen($UserInfo->firstname) >= 3 ? 'readonly aria-readonly="true"' : '' ?> required class="form-control" value="<?= $UserInfo->firstname ?>" placeholder="Firstname ...">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="list-group-item">
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="middlename" <?= strlen($UserInfo->middlename) >= 3 ? 'readonly aria-readonly="true"' : '' ?> required class="form-control" value="<?= $UserInfo->middlename ?>" placeholder="Middlename ...">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="list-group-item">
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-9" style="width: 100%;">
                                    <input type="tel" id="phone" style="width: 100%;" <?= strlen($UserInfo->mobile) >= 11 ? 'readonly aria-readonly="true"' : '' ?> name="mobile" required class="form-control" value="<?= $UserInfo->mobile ?>" placeholder="Telephone ...">
                                </div>
                            </div>
                        </div>
