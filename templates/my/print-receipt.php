...
<div class="container bg-white page__container" id="payreciept">
    <form>
        ...
        <div class="row">
            <div class="col-lg-9">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p class="text-black-50">ENUGU STATE UNIVERSITY OF SCIENCE AND TECHNOLOGY, Enugu State, Nigeria</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 text-lg-right d-flex flex-lg-column mb-24pt mb-lg-0 border-bottom border-lg-0 pb-16pt pb-lg-0">
                ...
                <?php if ($InvoiceInfo->tranx_status == "pending") : ?>
                    ...
                    <?php endif; ?>
                <?php else : ?>
                    <div><a href="/my/apps/6714694/print" class="btn btn-accent"><i class="material-icons icon--right">print</i></a></div>
                <?php endif; ?>
            </div>
        </div>
